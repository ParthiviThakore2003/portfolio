...
const Portfolio = () => {
  const soloProjects = [
    ...
    {
      id: 3,
      title: 'ML Model on Heart Disease Detection',
      img: IMG2,
      description: 'A Machine Learning Model to accurately detect and predict if a person is suffering from a heart disease using given dataset',
    ...
    {
      id: 5,
      title: 'Review Paper on Hand Gesture Recognition',
      img: IMG5,
      description:
    ...
    {
      id: 6,
      title: 'Research Paper on An Interface for Communication for the Deaf using Hand Gesture Recognition',
      img: IMG6,
      description:
